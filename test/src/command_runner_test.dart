...
import 'package:pocketflow_website_chatbot/src/command_runner.dart';
import 'package:pocketflow_website_chatbot/src/version.dart';
...
void main() {
  group('PocketflowWebsiteChatbotCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late PocketflowWebsiteChatbotCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = PocketflowWebsiteChatbotCommandRunner(
        logger: logger,
    ...
    test(
      ...
      () {
        final commandRunner = PocketflowWebsiteChatbotCommandRunner();
